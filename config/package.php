...
return array(
    ...
    'package'       => array(
        ...
        'default_wordpress_cookie' => 'wordpress',
        ...
        'log'                      => array(
            ...
            'update_dir_path'       => "Changed [dir] directory from " . \WP_CLI_Helper::color("[from]", "B") . " to " . \WP_CLI_Helper::color("[to]", "B") . ".",
            'create_db'             => "Created '[db_name]' Database.",
            'install_wp'            => "Install WordPress.",
            'install_wp_network'    => "Install WordPress Multi-site Network.",
            ...
            'created_site'          => "Created '" . \WP_CLI_Helper::color("[slug]", "Y") . "' site.",
            ...
            'er_delete_no_theme'    => "Can't delete the currently active theme '" . \WP_CLI_Helper::color("[theme]", "Y") . "'.",
            'is_now_theme_active'   => "The '[stylesheet]' theme is already active.",
            'theme_not_found'       => "The '" . \WP_CLI_Helper::color("[stylesheet]", "Y") . "' theme was not found for switching in your WordPress.",
            'switch_to_theme'       => "Switched to '" . \WP_CLI_Helper::color("[stylesheet]", "Y") . "' theme.",
            'run_pkg_commands'      => "Run WordPress package commands.",
            'run_cmd'               => "Run '" . \WP_CLI_Helper::color("[cmd]", "G") . "' command[more].",
            'er_nested_dir'         => "The '" . \WP_CLI_Helper::color("[dir]", "R") . "' folder should not be in the nested folder.",
            ...
            'not_change_pkg'        => "no changes found in the WordPress package file.",
